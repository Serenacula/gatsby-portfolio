		...
		<Wrapper>
			...
			<div className="firstColourBackground">
				<div className="mainColumn">
					...
					<NavigationBar links={menuItems} suppressFirstRender={true} suppressLogo={true} />
			...
			<div className="secondColourBackground">
				...
				<div className={combine("mainColumn", styles.secondSection)}>
					...
					<p>{"Heya..! I'm a newbie web dev, living in Leeds, UK."}</p>
					
					<p>Last summer I decided to learn how to make websites in my spare time. This is the result!</p>
			...
			<div className="thirdColourBackground">
				...
				<div className={combine("mainColumn", styles.thirdSection)}>
					...
					<div className={combine("firstColourBackground", styles.innerDiv)}>
